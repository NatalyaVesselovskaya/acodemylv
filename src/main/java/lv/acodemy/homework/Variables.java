...
public class Variables {
    public static void main(String[] args) {
        ...
        int populationStockholm = 975551;
        System.out.println("Population of Stockholm is " + populationStockholm);

        int populationRome = 2873000;
        System.out.println("Population of Rome is " + populationRome + " in 2017");

        int populationParis = 2188000;
        System.out.println("Population of Paris is " + populationParis);
        ...
        float testScoreEng = 64.5f;
        System.out.println("English test: " + testScoreEng + "%");

        float testScoreEcon = 75.9f;
        System.out.println("Economics test: " + testScoreEcon + "%");
        ...
        double share8 = 23298.32;
        System.out.println(share8);

        double share9 = 4202.432;
        System.out.println(share9);
        ...
        System.out.println(isOctober);

        boolean isMay = false;
        System.out.println(isMay);
